...
# Summon
execute as @s[scores={playerID=1}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initConvPlController","convPlControllerPlayer1"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,14,0,1]}
execute as @s[scores={playerID=2}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initConvPlController","convPlControllerPlayer2"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,14,0,2]}
execute as @s[scores={playerID=3}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initConvPlController","convPlControllerPlayer3"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,14,0,3]}
execute as @s[scores={playerID=4}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initConvPlController","convPlControllerPlayer4"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,14,0,4]}
