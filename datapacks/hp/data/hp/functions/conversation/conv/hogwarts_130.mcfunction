...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Hogsmeade'deki Zonko's Joke Shop'u tekrar ziyaret etmek için sabırsızlanıyorum. \\n\\n\\n\\n\\n\"}"}
