...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Ravenclaw kulesini arıyorsanız, sadece merdivenlerden yukarı çıkın ve kütüphaneye ulaştığınızda sola dönün! En azından dün öyleydi... \\n\\n\\n\"}"}
