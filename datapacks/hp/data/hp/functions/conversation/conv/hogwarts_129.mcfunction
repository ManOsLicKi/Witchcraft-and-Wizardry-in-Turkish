...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Slytherin ortak odasını mı arıyorsunuz? Ya da İksir sınıfını mı? Bu yön işaretleri oldukça faydalı, değil mi? \\n\\n\\n\\n\"}"}
