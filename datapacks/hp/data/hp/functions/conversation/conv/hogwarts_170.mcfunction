...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bilgisayarımı okula getirdim ama burada çalışmıyor gibi görünüyor. Garip bir sihir. Hiçbir fiş de bulamıyorum. \\n\\n\\n\"}"}
