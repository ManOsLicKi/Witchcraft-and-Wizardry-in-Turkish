...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bir zamanlar Antik Rünler'in bir dönemini 3 saatte öğrenmiştim. Astroloji'nin iki dönemi yeterince kolay olmalı. \\n\\n\\n\\n\"}"}
