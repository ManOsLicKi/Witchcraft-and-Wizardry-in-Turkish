...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Ailem nesillerdir bu dükkânı işletiyordu ve şimdi bu Mulpepper denen adam bizi neredeyse iflas ettirecekti! \\n\\n\\n\\n\"}"}
