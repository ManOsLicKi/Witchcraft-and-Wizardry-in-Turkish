...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Ah, keşke Dönüşüm sınavının bugün değil de önümüzdeki hafta olacağını, bütün gece ders çalışmadan önce bilseydim. \\n\\n\\n\"}"}
