...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Kimi destekliyorsunuz? Appleby Arrows'u mu? Chudley Cannons'ı mı? Falmouth Falcons'ı mı? Kişisel olarak Montrose Magpies'ı destekliyorum tabii ki. \\n\\n\\n\"}"}
