...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bir dakika içinde kütüphaneye geri dönüyorum. Bitkibilim ödevim için biraz araştırma yapmam gerekiyor. \\n\\n\\n\\n\"}"}
