...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"O kadar zekiyim ki bazen söylediklerimin tek bir kelimesini bile anlamıyorum. \\n\\n\\n\\n\"}"}
