...
# In Conversation
execute as 0-0-e-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectUp],UUID:[I;0,15,0,5]}
execute as 0-0-e-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectDown],UUID:[I;0,15,0,6]}
execute as 0-0-e-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectLeft],UUID:[I;0,15,0,7]}
execute as 0-0-e-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectRight],UUID:[I;0,15,0,8]}
