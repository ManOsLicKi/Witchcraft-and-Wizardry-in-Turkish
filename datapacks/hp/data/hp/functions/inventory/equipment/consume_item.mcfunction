...
execute as @s[tag=consumeFromInventory] if entity @e[tag=inventoryOption,tag=selected,scores={InvItemID=10}] run tag @s add exitInventory
execute as @s[tag=consumeFromInventory] if entity @e[tag=inventoryOption,tag=selected,scores={InvItemID=10}] run tag @s remove invInspectItem
