...
execute as @e[tag=hover,limit=1,tag=!fluxweed] run data merge entity @s {Glowing:0b,ArmorItems:[{},{},{},{id:"minecraft:golden_hoe",Count:1b,tag:{Unbreakable:1b,Damage:32}}]}
