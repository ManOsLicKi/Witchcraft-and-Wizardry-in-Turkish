...
# Scroll testers
execute at 0-0-c-0-3 positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectUp],UUID:[I;0,11,0,9]}
execute at 0-0-c-0-3 positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectDown],UUID:[I;0,11,0,10]}
execute at 0-0-c-0-3 positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectLeft],UUID:[I;0,11,0,11]}
execute at 0-0-c-0-3 positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectRight],UUID:[I;0,11,0,12]}
