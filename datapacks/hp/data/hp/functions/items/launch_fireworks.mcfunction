...
### Fireworks Rocket ###
execute at @s run summon snowball ^ ^ ^0.5 {damage:2d,Team:"NPC",NoGravity:1b,Color:-1,Tags:["spellEntity","fireworksRocket","fireworksRocket_ini"],Passengers:[{id:"minecraft:armor_stand",Team:"NPC",Invulnerable:1b,Small:1b,Invisible:1b,Marker:1b,Tags:["spellEntity","fireworksRocketDirection","fireworksRocketDirection_ini"]}]}
