...
execute if score @e[type=armor_stand,name=AlleyPosition,limit=1] doorTpsCount matches 0 run setblock 2848 59 798 minecraft:lectern[facing=north,powered=true]
...
execute if score @e[type=armor_stand,name=AlleyPosition,limit=1] doorTpsCount matches 0 run setblock 2848 57 798 minecraft:lectern[facing=north,powered=true]
