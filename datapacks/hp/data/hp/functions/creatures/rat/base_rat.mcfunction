...
execute as @s[scores={animTest=1}] as @s[tag=slowDown,tag=!isSlowedDown] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.15}]}
execute as @s[scores={animTest=1}] as @s[tag=slowDown,tag=!isSlowedDown] run tag @s add isSlowedDown
execute as @s[scores={animTest=1}] as @s[tag=!slowDown,tag=isSlowedDown] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.25}]}
