...
# If only left arm
execute as @s[tag=leftArm,tag=!leftAttack,scores={tmp2=57}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.125}]}
execute as @s[tag=leftArm,tag=!leftAttack,scores={tmp2=49}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0}]}
execute as @s[tag=leftArm,tag=leftAttack] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.1}]}

# If only right arm
execute as @s[tag=rightArm,tag=!rightAttack,scores={tmp3=57}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.125}]}
execute as @s[tag=rightArm,tag=!rightAttack,scores={tmp3=49}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0}]}
execute as @s[tag=rightArm,tag=rightAttack] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.1}]}
