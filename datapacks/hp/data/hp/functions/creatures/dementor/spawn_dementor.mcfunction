execute at @s run summon phantom ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:golden_hoe",Count:1b,tag:{Damage:32}}],Size:6,PersistenceRequired:1b,Tags:["creature","dementor","dementorEngine","dementorEngineIsBeingSummoned"],Invulnerable:1b,Team:"Creature",Attributes:[{Name:generic.follow_range,Base:150},{Name:generic.attack_damage,Base:50}]}
