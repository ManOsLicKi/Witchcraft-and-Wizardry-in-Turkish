...
execute as @s[scores={animTest=150}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0}]}
...
execute as @s[scores={animTest=120}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.3}]}
...
execute as @s[tag=glowWaveCreature,scores={glowTimer=150000..}] run effect give @s minecraft:glowing 1 1 true