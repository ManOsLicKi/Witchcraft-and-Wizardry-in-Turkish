...
execute as @s[tag=deathEaterCreature] at @s run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.3}]}

execute as @s[tag=largeSpiderCreature] at @s run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.3}]}
