...
execute as @s[scores={deathEaterFire=80}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0}]}
...
execute as @s[scores={deathEaterFire=68}] at @s run summon snowball ^ ^ ^0.25 {damage:1d,Team:"Creature",NoGravity:1b,Color:-1,Tags:["deathEaterSpell","deathEaterSpell_ini"],Passengers:[{id:"minecraft:armor_stand",Invulnerable:1b,Small:1b,Invisible:1b,Marker:1b,Tags:["deathEaterSpellDirection","deathEaterSpellDirection_ini"]}]}
...
execute as @s[scores={deathEaterFire=40}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.3}]}
