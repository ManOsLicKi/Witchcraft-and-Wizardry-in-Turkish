...
replaceitem entity @s[scores={hotbar_stage=10},tag=!showMana] hotbar.5 minecraft:wooden_hoe{display:{Name:"{\"text\":\"Envanter\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:59,Unbreakable:1b,qDetect:1b}
...
execute if entity @e[tag=hover,tag=convNPC] store success score @s tmp run replaceitem entity @s hotbar.7 minecraft:golden_hoe{Damage:30,Unbreakable:1b,display:{Name:"{\"text\":\"Ayarlar\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,qDetect:1b} 1
execute if entity @e[tag=hover,tag=!convNPC,tag=!noInteraction,tag=!largeChest,tag=!smallChest] store success score @s tmp run replaceitem entity @s hotbar.7 minecraft:golden_hoe{Damage:29,Unbreakable:1b,display:{Name:"{\"text\":\"Ayarlar\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,qDetect:1b} 1
execute if entity @e[tag=hover,tag=chest,tag=!isDroppedItem] store success score @s tmp run replaceitem entity @s hotbar.7 minecraft:golden_hoe{Damage:27,Unbreakable:1b,display:{Name:"{\"text\":\"Ayarlar\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,qDetect:1b} 1
replaceitem entity @s[scores={tmp=0}] hotbar.7 minecraft:golden_hoe{Damage:31,Unbreakable:1b,display:{Name:"{\"text\":\"Ayarlar\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,qDetect:1b} 1
...
replaceitem entity @s[tag=!showingTrackedQuest,tag=!playingQuestAnim] hotbar.1 minecraft:golden_hoe{display:{Name:"{\"text\":\"Çapulcu Haritası\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:32,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=showingTrackedQuest,tag=!playingQuestAnim] unless score @s lastRegion = @s questRegion run replaceitem entity @s hotbar.2 minecraft:stone_axe{display:{Name:"{\"text\":\"Görev Günlüğü\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:95,Unbreakable:1b,qDetect:1b}

replaceitem entity @s[tag=!showingTrackedQuest,tag=!playingQuestAnim] hotbar.2 minecraft:golden_hoe{display:{Name:"{\"text\":\"Görev Günlüğü\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:32,Unbreakable:1b,qDetect:1b}
