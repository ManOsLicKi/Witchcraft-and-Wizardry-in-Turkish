...
execute as @s[scores={playerID=1}] run bossbar set minecraft:player1info name {"text":"Ayarlar","bold":true,"color":"gray"}
execute as @s[scores={playerID=2}] run bossbar set minecraft:player2info name {"text":"Ayarlar","bold":true,"color":"gray"}
execute as @s[scores={playerID=3}] run bossbar set minecraft:player3info name {"text":"Ayarlar","bold":true,"color":"gray"}
execute as @s[scores={playerID=4}] run bossbar set minecraft:player4info name {"text":"Ayarlar","bold":true,"color":"gray"}
