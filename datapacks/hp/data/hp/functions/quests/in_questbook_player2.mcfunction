...
execute store result score @s falling run data get entity 0-0-d-0-2 FallDistance 10
...
# Scroll testers
execute as 0-0-d-0-2 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectUp],UUID:[I;0,11,0,5]}
execute as 0-0-d-0-2 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectDown],UUID:[I;0,11,0,6]}
execute as 0-0-d-0-2 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectLeft],UUID:[I;0,11,0,7]}
execute as 0-0-d-0-2 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectRight],UUID:[I;0,11,0,8]}
...
execute at 0-0-d-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=questSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:quests/quest_book_scroll_down

# Scroll up
execute as @s[tag=hasChangedSlotUp,tag=!hasScrolled] run function hp:quests/quest_book_scroll_up
execute at 0-0-d-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=questSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:quests/quest_book_scroll_up
...
execute store result score @s tmp run data get entity 0-0-d-0-2 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-d-0-2 Rotation[1] 1000
...
execute at 0-0-d-0-2 as @s[distance=0.001..] run tag @s add lookTP
execute as @s[tag=lookTP] run tp @s 0-0-d-0-2
