...
execute as @s[scores={questMenu=1},tag=!preventDoubleExecution,tag=lockTrackedQuest,tag=!noQuests] run title @s subtitle {"text":"You cannot change your tracked quest right now","bold":false,"color":"red"}
