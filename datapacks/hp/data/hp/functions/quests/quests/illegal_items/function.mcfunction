...
execute as @s[scores={questState=1..3,playerID=1,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4929,dx=228,y=0,dy=255,z=6958,dz=214] run bossbar set minecraft:player1quest name ["",{"text":"Speak with Draco Malfoy to travel to Malfoy Manor","color":"gold"}]
execute as @s[scores={questState=1..3,playerID=2,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4929,dx=228,y=0,dy=255,z=6958,dz=214] run bossbar set minecraft:player2quest name ["",{"text":"Speak with Draco Malfoy to travel to Malfoy Manor","color":"gold"}]
execute as @s[scores={questState=1..3,playerID=3,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4929,dx=228,y=0,dy=255,z=6958,dz=214] run bossbar set minecraft:player3quest name ["",{"text":"Speak with Draco Malfoy to travel to Malfoy Manor","color":"gold"}]
execute as @s[scores={questState=1..3,playerID=4,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4929,dx=228,y=0,dy=255,z=6958,dz=214] run bossbar set minecraft:player4quest name ["",{"text":"Speak with Draco Malfoy to travel to Malfoy Manor","color":"gold"}]



### Tracked Quest ###
execute as @s[scores={questState=1,lastRegion=11},tag=isTrackedQuest] run tag @s remove hideQuestTracking
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1341,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1340,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2,playerID=1,lastRegion=11},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Collect the illegal items from Malfoy Manor (","color":"gold"},{"score":{"name":"illegalItemsFound","objective":"sharedQuests"},"color":"gold"},{"text":" / 5","color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=2,playerID=2,lastRegion=11},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Collect the illegal items from Malfoy Manor (","color":"gold"},{"score":{"name":"illegalItemsFound","objective":"sharedQuests"},"color":"gold"},{"text":" / 5","color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=2,playerID=3,lastRegion=11},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Collect the illegal items from Malfoy Manor (","color":"gold"},{"score":{"name":"illegalItemsFound","objective":"sharedQuests"},"color":"gold"},{"text":" / 5","color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=2,playerID=4,lastRegion=11},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Collect the illegal items from Malfoy Manor (","color":"gold"},{"score":{"name":"illegalItemsFound","objective":"sharedQuests"},"color":"gold"},{"text":" / 5","color":"gold"},{"text":")","color":"gold"}]
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1339,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ I've collected all the items\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1338,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ I have these items that might interest you\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
