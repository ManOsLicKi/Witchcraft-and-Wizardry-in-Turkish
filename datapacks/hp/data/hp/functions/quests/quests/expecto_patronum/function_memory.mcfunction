...
execute as @s[tag=newState] run scoreboard players set @s selectedSpell 8
execute as @s[tag=newState] run scoreboard players set @s currentSpell 8
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1538,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=5},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1537,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Wait for your turn to approach the chest","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Wait for your turn to approach the chest","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Wait for your turn to approach the chest","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Wait for your turn to approach the chest","color":"gold"}]
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Approach the chest","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Approach the chest","color":"gold"}]
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Approach the chest","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Approach the chest","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Repel the dementor with the 'Expecto Patronum' spell","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Repel the dementor with the 'Expecto Patronum' spell","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Repel the dementor with the 'Expecto Patronum' spell","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Repel the dementor with the 'Expecto Patronum' spell","color":"gold"}]
...
execute as @s[scores={questState=9},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1467,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=11},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1464,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=11,playerID=1},tag=isTrackedQuest] if score patronusTimer p1Quests matches 120000..125000 run bossbar set minecraft:player1quest name ["",{"text":"Fend off the dementors for 2 minutes!","color":"gold"}]	
execute as @s[scores={questState=11,playerID=2},tag=isTrackedQuest] if score patronusTimer p2Quests matches 120000..125000 run bossbar set minecraft:player2quest name ["",{"text":"Fend off the dementors for 2 minutes!","color":"gold"}]
execute as @s[scores={questState=11,playerID=3},tag=isTrackedQuest] if score patronusTimer p3Quests matches 120000..125000 run bossbar set minecraft:player3quest name ["",{"text":"Fend off the dementors for 2 minutes!","color":"gold"}]
execute as @s[scores={questState=11,playerID=4},tag=isTrackedQuest] if score patronusTimer p4Quests matches 120000..125000 run bossbar set minecraft:player4quest name ["",{"text":"Fend off the dementors for 2 minutes!","color":"gold"}]
...
### Trigger ###
execute as @s[scores={questState=11,playerID=1},tag=gameLeader] if score patronusTimer p1Quests matches ..0 run tag @s add newState
execute as @s[scores={questState=11,playerID=2},tag=gameLeader] if score patronusTimer p2Quests matches ..0 run tag @s add newState
execute as @s[scores={questState=11,playerID=3},tag=gameLeader] if score patronusTimer p3Quests matches ..0 run tag @s add newState
execute as @s[scores={questState=11,playerID=4},tag=gameLeader] if score patronusTimer p4Quests matches ..0 run tag @s add newState
...
execute as @s[scores={questState=12},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1466,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=15},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1539,Unbreakable:1b,qDetect:1b}
...
scoreboard players set @s tmp 0
execute positioned 8026 133 66 as @a[distance=..5,scores={trackedQuestID=21,trackQuestState=16},tag=inNormalState] run scoreboard players add @p[tag=activePlayer] tmp 1
...
execute as @s[scores={questState=17},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1465,Unbreakable:1b,qDetect:1b}
