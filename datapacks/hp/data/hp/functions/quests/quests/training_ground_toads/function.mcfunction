...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1424,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=1,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Defeat 20 flobberworms (","color":"gold"},{"score":{"name":"trainingGroundToadsKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 20)","color":"gold"}]
execute as @s[scores={questState=1,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Defeat 20 flobberworms (","color":"gold"},{"score":{"name":"trainingGroundToadsKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 20)","color":"gold"}]
execute as @s[scores={questState=1,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Defeat 20 flobberworms (","color":"gold"},{"score":{"name":"trainingGroundToadsKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 20)","color":"gold"}]
execute as @s[scores={questState=1,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Defeat 20 flobberworms (","color":"gold"},{"score":{"name":"trainingGroundToadsKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 20)","color":"gold"}]
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1423,Unbreakable:1b,qDetect:1b}
