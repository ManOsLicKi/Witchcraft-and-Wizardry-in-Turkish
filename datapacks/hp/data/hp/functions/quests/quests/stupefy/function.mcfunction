...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1492,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1494,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=6},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1493,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Use Stupefy to damage opponents!","color":"gold"}]	
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Use Stupefy to damage opponents!","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Use Stupefy to damage opponents!","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Use Stupefy to damage opponents!","color":"gold"}]
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the boggart!","color":"gold"}]
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the boggart!","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the boggart!","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the boggart!","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Defeat 3 waves of enemies!","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 1","color":"gold"}]	
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 1","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
...
execute as @s[scores={questState=8,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=8,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=8,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=8,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=8,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=8,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=8,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=8,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 2","color":"gold"}]
...
execute as @s[scores={questState=8,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=8,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=8,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=8,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
...
execute as @s[scores={questState=9,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=9,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=9,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=9,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=9,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=9,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=9,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=9,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 3","color":"gold"}]
...
execute as @s[scores={questState=9,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=9,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=9,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=9,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
...
execute as @s[scores={questState=10,playerID=1},tag=isTrackedQuest] if score stupefyTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=10,playerID=2},tag=isTrackedQuest] if score stupefyTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=10,playerID=3},tag=isTrackedQuest] if score stupefyTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=10,playerID=4},tag=isTrackedQuest] if score stupefyTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Opponents defeated!","color":"gold"}]
