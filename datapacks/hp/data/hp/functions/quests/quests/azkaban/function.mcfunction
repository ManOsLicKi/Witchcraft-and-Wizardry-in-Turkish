...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1455,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Defeat 5 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Defeat 5 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Defeat 5 waves of enemies!","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Defeat 5 waves of enemies!","color":"gold"}]
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 1","color":"gold"}]	
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 1","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 1","color":"gold"}]
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 6)","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 2","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 8)","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 3","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 4","color":"gold"}]
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 4","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 4","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 4","color":"gold"}]
...
execute as @s[scores={questState=6,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=6,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=6,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=6,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 10)","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"Wave complete!","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"Wave complete!","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Wave 5","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Wave 5","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Wave 5","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Wave 5","color":"gold"}]
...
execute as @s[scores={questState=7,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=7,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=7,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
execute as @s[scores={questState=7,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Defeat the opponents (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" of 12)","color":"gold"}]
...
execute as @s[scores={questState=8},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1454,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=8,playerID=1},tag=isTrackedQuest] if score azkabanTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=8,playerID=2},tag=isTrackedQuest] if score azkabanTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=8,playerID=3},tag=isTrackedQuest] if score azkabanTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Opponents defeated!","color":"gold"}]
execute as @s[scores={questState=8,playerID=4},tag=isTrackedQuest] if score azkabanTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Opponents defeated!","color":"gold"}]
...
execute as @s[scores={questState=9},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1495,Unbreakable:1b,qDetect:1b}
