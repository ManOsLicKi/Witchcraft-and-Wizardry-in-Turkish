...
execute as @s[scores={questState=1..6,playerID=1,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4992,dx=819,y=0,dy=255,z=3968,dz=819] run bossbar set minecraft:player1quest name ["",{"text":"Speak with Luna Lovegood to travel to the Lovegood Residence","color":"gold"}]
execute as @s[scores={questState=1..6,playerID=2,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4992,dx=819,y=0,dy=255,z=3968,dz=819] run bossbar set minecraft:player2quest name ["",{"text":"Speak with Luna Lovegood to travel to the Lovegood Residence","color":"gold"}]
execute as @s[scores={questState=1..6,playerID=3,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4992,dx=819,y=0,dy=255,z=3968,dz=819] run bossbar set minecraft:player3quest name ["",{"text":"Speak with Luna Lovegood to travel to the Lovegood Residence","color":"gold"}]
execute as @s[scores={questState=1..6,playerID=4,lastRegion=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] unless entity @s[x=4992,dx=819,y=0,dy=255,z=3968,dz=819] run bossbar set minecraft:player4quest name ["",{"text":"Speak with Luna Lovegood to travel to the Lovegood Residence","color":"gold"}]


### Tracked Quest ###
execute as @s[scores={questState=1,lastRegion=10},tag=isTrackedQuest] run tag @s remove hideQuestTracking
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1399,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1398,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Luna said you are looking for nargles?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1396,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=5},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1395,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=newState,scores={playerID=1}] run bossbar set minecraft:player1quest name {"text":"Report your findings to Xenophilius Lovegood","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=2}] run bossbar set minecraft:player2quest name {"text":"Report your findings to Xenophilius Lovegood","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=3}] run bossbar set minecraft:player3quest name {"text":"Report your findings to Xenophilius Lovegood","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=4}] run bossbar set minecraft:player4quest name {"text":"Report your findings to Xenophilius Lovegood","bold":false,"color":"gold"}
...
execute as @s[scores={questState=6},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1394,Unbreakable:1b,qDetect:1b}
