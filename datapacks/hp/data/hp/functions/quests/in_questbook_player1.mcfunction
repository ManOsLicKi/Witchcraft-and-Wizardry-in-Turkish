...
# Scroll testers
execute as 0-0-d-0-1 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectUp],UUID:[I;0,11,0,1]}
execute as 0-0-d-0-1 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectDown],UUID:[I;0,11,0,2]}
execute as 0-0-d-0-1 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectLeft],UUID:[I;0,11,0,3]}
execute as 0-0-d-0-1 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectRight],UUID:[I;0,11,0,4]}
