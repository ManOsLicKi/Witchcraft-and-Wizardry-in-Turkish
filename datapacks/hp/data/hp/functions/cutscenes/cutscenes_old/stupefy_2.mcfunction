...
execute as @s[scores={cutSceneTimer=161..311}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"                 "}]
...
execute as @s[scores={cutSceneTimer=311..400}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"   "}]
...
execute as @s[scores={cutSceneTimer=400..480}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"      "}]
...
execute as @s[scores={cutSceneTimer=480..650}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"                "}]
...
execute as @s[scores={cutSceneTimer=650..800}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"                 "}]
...
execute as @s[scores={cutSceneTimer=800..950}] run title @s actionbar ["",{"text":""},{"text":"","color":"dark_gray"},{"text":"   "}]
