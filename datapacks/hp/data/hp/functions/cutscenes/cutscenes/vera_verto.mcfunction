...
execute as @s[scores={cutSceneTimer=90..200}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Dikkatinizi rica ediyorum!"}]
...
execute as @s[scores={cutSceneTimer=200..320}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Bugün Fera Verto büyüsünü inceleyeceğiz."}]
...
execute as @s[scores={cutSceneTimer=330..420}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Bu büyü çevrenizin şeklini ve özelliklerini değiştirmenize olanak sağlar."}]
...
execute as @s[scores={cutSceneTimer=420..500}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"ve belirli nesneleri ve düşmanları dönüştürmenize olanak tanır."}]
...
execute as @s[scores={cutSceneTimer=500..560}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Bunun gibi bir şey;"}]
...
execute as @s[scores={cutSceneTimer=600..660}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Fera Verto"}]
...
execute as @s[scores={cutSceneTimer=700..850}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Şimdi sen. Tesisin bir kısmı uygulama için tahsis edilmiştir."}]
...
execute as @s[scores={cutSceneTimer=850..1000}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Bir nesnenin çevresinde mavi parçacıklar görürseniz onu dönüştürebilirsiniz."}]
...
execute as @s[scores={cutSceneTimer=1000..1090}] run title @s actionbar ["",{"text":""},{"text":"McGonagall;","color":"dark_gray"},{"text":"Şimdi sen. Size iyi şanslar diliyorum!"}]
