...
execute as @s[scores={cutSceneTimer=85}] run title @s subtitle ["",{"text":"Godric's Hollow'a","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=85}] run title @s title {"text":"Seyahat Ediliyor","color":"gray"}
