...
execute as @s[scores={cutSceneTimer=20..110}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Merak etme, buradayım! Takviyeyle geldim..."}]
...
execute as @s[scores={cutSceneTimer=111..200}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Ah. Durumu kontrol altına almış gibisin."}]
...
execute as @s[scores={cutSceneTimer=201..300}] run title @s actionbar ["",{"text":""},{"text":"Bakanlık çalışanı;","color":"dark_gray"},{"text":"Durum nedir? Yiyenler...? Anlamsız. Acımasız suçlamalar!"}]
...
execute as @s[scores={cutSceneTimer=301..360}] run title @s actionbar ["",{"text":""},{"text":"Bakanlık çalışanı;","color":"dark_gray"},{"text":"Sanırım burada neler olduğunu biliyorum."}]
...
execute as @s[scores={cutSceneTimer=361..450}] run title @s actionbar ["",{"text":""},{"text":"Bakanlık çalışanı;","color":"dark_gray"},{"text":"Öğrencilerinizden biri yanlışlıkla bu duvarı havaya uçurdu ve şimdi siz onu örtbas etmeye çalışıyorsunuz."}]
...
execute as @s[scores={cutSceneTimer=451..540}] run title @s actionbar ["",{"text":""},{"text":"Bakanlık çalışanı;","color":"dark_gray"},{"text":"Seni izliyorum Doublecross."}]
