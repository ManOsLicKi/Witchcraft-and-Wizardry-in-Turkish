...
execute as @s[scores={cutSceneTimer=20}] run title @s subtitle ["",{"text":"Sihir Bakanlığı","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=20}] run title @s title {"text":"Seyahat etmek","color":"gray"}
