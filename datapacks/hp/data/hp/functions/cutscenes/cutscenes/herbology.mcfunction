...
execute as @s[scores={cutSceneTimer=70..200}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"1 numaralı seraya hoş geldiniz."}]
...
execute as @s[scores={cutSceneTimer=200..360}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Ve gelin, bugün Mandrake'le nasıl başa çıkacağımızı öğreneceğiz."}]
...
execute as @s[scores={cutSceneTimer=360..480}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Mandragora veya Mandragorum çok tehlikeli bir bitkidir!"}]
...
execute as @s[scores={cutSceneTimer=480..570}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Onun çığlığı, onu duyan herkes için öldürücüdür."}]
...
execute as @s[scores={cutSceneTimer=570..670}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"bu yüzden korunmak için kulaklık kullanmalısınız!"}]
...
execute as @s[scores={cutSceneTimer=670..760}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Mandragoralarımız hâlâ çok genç, dolayısıyla çığlıkları muhtemelen sizi öldürmeyecek."}]
...
execute as @s[scores={cutSceneTimer=760..860}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"ama dikkatli olun, sizi birkaç saat boyunca sersemletebilirler."}]
...
execute as @s[scores={cutSceneTimer=860..1000}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Vahşi doğada biriyle karşılaşırsanız dikkatli olun!"}]
...
execute as @s[scores={cutSceneTimer=1001..1100}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Mümkünse uzak dur ve onu rahatsız etmemeye çalış."}]
...
execute as @s[scores={cutSceneTimer=1101..1200}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Ona yaklaşmanız gerekiyorsa kulaklığınızın takılı olduğundan emin olun."}]
...
execute as @s[scores={cutSceneTimer=1201..1300}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Kulaklık taktığınızda Mandrake'i toprağa geri döndürebilirsiniz."}]
...
execute as @s[scores={cutSceneTimer=1301..1370}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Bu onların ağlamasını kısa bir süreliğine durduracaktır."}]
...
execute as @s[scores={cutSceneTimer=1371..1510}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Kulaklığınızı düşürmemeye dikkat edin! Dikkatli hareket etmeniz gerekecek."}]
...
execute as @s[scores={cutSceneTimer=1511..1700}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"Pratik yapmak için seralara gidip dört yıldız toplamanız ve sonra bana dönmeniz gerekiyor."}]
...
execute as @s[scores={cutSceneTimer=1700..1800}] run title @s actionbar ["",{"text":""},{"text":"Kök;","color":"dark_gray"},{"text":"İyi şanlar!"}]
