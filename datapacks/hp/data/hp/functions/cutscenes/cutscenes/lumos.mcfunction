...
execute as @s[scores={cutSceneTimer=25..160}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Merhaba öğrenciler. Ben Profesör Flitwick ve Hogwarts'ta Büyü öğretmeniyim."}]
...
execute as @s[scores={cutSceneTimer=161..230}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"İlk görevde basit bir büyü öğreneceğiz - 'Lumos'"}]
...
execute as @s[scores={cutSceneTimer=231..350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"karanlık yerleri aydınlatmak için asanın ucundan ışık yaymanıza olanak tanır."}]
...
execute as @s[scores={cutSceneTimer=351..490}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Görülemeyecek kadar karanlık bir odada olduğunuzda,"}]
...
execute as @s[scores={cutSceneTimer=491..590}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"büyüyü ⌠ tuşuna iki kez basarak çağırmalısın"}]
...
execute as @s[scores={cutSceneTimer=590..700}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Lumos'u pratik edebilmen için sana tamamlaman gereken özel bir görev hazırladım."}]
...
execute as @s[scores={cutSceneTimer=701..780}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Görev basit;"}]
...
execute as @s[scores={cutSceneTimer=781..940}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bu labirentte beş yıldız toplayın ve dersi tamamlamak için bana dönün."}]
...
execute as @s[scores={cutSceneTimer=941..1100}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Ama bu labirent çok karanlık. Yolu bulmak için sihir kullanmanız gerekecek."}]
...
execute as @s[scores={cutSceneTimer=1101..1180}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Size iyi şanslar diliyorum!"}]
