...
execute as @s[scores={cutSceneTimer=20..120}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Başlamaya hazır mısınız? Müthiş."}]
...
execute as @s[scores={cutSceneTimer=121..230}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Bildiğiniz gibi ihlal, ışınlanmanın büyülü bir şeklidir."}]
...
execute as @s[scores={cutSceneTimer=231..300}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"sizi anında bir yerden diğerine taşıyan şey."}]
...
execute as @s[scores={cutSceneTimer=301..350}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Bu özellik çok kullanışlıdır"}]
...
execute as @s[scores={cutSceneTimer=351..420}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"normalde erişilemeyen yerlere gitmeniz gerektiğinde."}]
...
execute as @s[scores={cutSceneTimer=421..480}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Göstereyim:"}]
...
execute as @s[scores={cutSceneTimer=551..610}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Bunun gibi"}]
...
execute as @s[scores={cutSceneTimer=651..800}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"İhlalde üç 'H' kuralını hatırlamak çok önemlidir; 'Odaklanma, Kalıcılık, Yavaşlık'"}]
...
execute as @s[scores={cutSceneTimer=801..870}] run title @s actionbar ["",{"text":""},{"text":"Çift çapraz;","color":"dark_gray"},{"text":"Sıra sende"}]
