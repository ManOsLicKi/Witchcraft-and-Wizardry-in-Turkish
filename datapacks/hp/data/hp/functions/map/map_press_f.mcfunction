...
execute as @s[tag=!softExitMap,tag=!invInspectItem,tag=!preventDoubleExecution,tag=selectedDestinationLocked,scores={convState=1..}] run title @s subtitle {"text":"You've not unlocked that destination!","bold":false,"color":"red"}
# Start state
