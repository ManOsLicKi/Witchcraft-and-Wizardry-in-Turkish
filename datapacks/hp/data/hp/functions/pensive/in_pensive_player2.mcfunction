...
# Scroll testers
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectUp],UUID:[I;0,18,0,5]}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectDown],UUID:[I;0,18,0,6]}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectLeft],UUID:[I;0,18,0,7]}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectRight],UUID:[I;0,18,0,8]}

# Sideways Scroll
# Select potion to brew
execute at 0-0-11-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectRight] run scoreboard players add @p selectCurrent 1
execute at 0-0-11-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectRight] run playsound minecraft:ui.button.click master @p ~ ~ ~ 0.5 1 0.5
execute at 0-0-11-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectLeft] run scoreboard players remove @p selectCurrent 1
execute at 0-0-11-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectLeft] run playsound minecraft:ui.button.click master @p ~ ~ ~ 0.5 1 0.5
...
execute at 0-0-11-0-2 as @s[distance=0.001..] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectDown] as @p run playsound minecraft:ui.button.click master @s[tag=invInspectItem,scores={selectSecondary=1}] ~ ~ ~ 0.5 1 0.5
execute at 0-0-11-0-2 as @s[distance=0.001..] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectDown] as @p run scoreboard players add @s[tag=invInspectItem,scores={selectSecondary=1}] selectSecondary 1
...
execute as @s[tag=hasChangedSlotUp,tag=invInspectItem,scores={selectSecondary=2}] run scoreboard players remove @s selectSecondary 1
execute at 0-0-11-0-2 as @s[distance=0.001..] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectUp] as @p run playsound minecraft:ui.button.click master @s[tag=invInspectItem,scores={selectSecondary=2}] ~ ~ ~ 0.5 1 0.5
execute at 0-0-11-0-2 as @s[distance=0.001..] at @s as @e[tag=pensiveSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectUp] as @p run scoreboard players remove @s[tag=invInspectItem,scores={selectSecondary=2}] selectSecondary 1
...
execute store result score @s tmp run data get entity 0-0-11-0-2 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-11-0-2 Rotation[1] 1000
...
execute at 0-0-11-0-2 as @s[distance=0.001..] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!inInventory] run tp @s 0-0-11-0-2
