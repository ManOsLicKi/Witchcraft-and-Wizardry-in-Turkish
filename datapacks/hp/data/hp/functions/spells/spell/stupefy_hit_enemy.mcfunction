...
# Damage (1.15+)
execute as @s[tag=!strengthAmplified] run scoreboard players set damage tmp 50
execute as @s[tag=strengthAmplified] run scoreboard players set damage tmp 75

scoreboard players set @s tmp3 0
execute as @s[scores={tmp3=0}] store success score @s tmp3 as @e[limit=1,sort=nearest,tag=creature,nbt={HurtTime:10s}] run function hp:spells/spell/stupefy_damage
execute as @s[scores={tmp3=0}] store success score @s tmp3 as @e[limit=1,sort=nearest,tag=creature,nbt={HurtTime:9s}] run function hp:spells/spell/stupefy_damage
