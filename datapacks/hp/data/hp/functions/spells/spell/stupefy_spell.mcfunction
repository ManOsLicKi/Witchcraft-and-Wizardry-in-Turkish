...
# Moved up here for 1.16. Snowball always breaks anyway unlike old trident system
################
# Apply Motion #
################
...
execute at @s[scores={idle=1..}] unless entity @e[tag=stupefySpell,distance=..1] run tag @s add hitSomething

# Detect if the trident is stuck in a block
execute at @s as @e[limit=1,sort=nearest,tag=stupefySpell,nbt={inGround:1b},distance=..1] run tag @s add hitSomething
...
execute at @s store result score @s spellX run data get entity @e[limit=1,sort=nearest,tag=stupefySpell,distance=..0.45] Pos[0] 100
execute at @s store result score @s spellY run data get entity @e[limit=1,sort=nearest,tag=stupefySpell,distance=..0.45] Pos[1] 100
execute at @s store result score @s spellZ run data get entity @e[limit=1,sort=nearest,tag=stupefySpell,distance=..0.45] Pos[2] 100
