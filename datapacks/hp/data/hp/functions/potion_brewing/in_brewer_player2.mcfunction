...
# Scroll testers
execute as 0-0-13-0-2 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectUp],UUID:[I;0,20,0,5]}
execute as 0-0-13-0-2 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectDown],UUID:[I;0,20,0,6]}
execute as 0-0-13-0-2 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectLeft],UUID:[I;0,20,0,7]}
execute as 0-0-13-0-2 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectRight],UUID:[I;0,20,0,8]}

# Sideways Scroll
# Select potion to brew
execute at 0-0-13-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectRight] run scoreboard players add @p selectCurrent 1
execute at 0-0-13-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectRight] run playsound minecraft:ui.button.click master @p ~ ~ ~ 0.5 1 0.5
execute at 0-0-13-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectLeft] run scoreboard players remove @p selectCurrent 1
execute at 0-0-13-0-2 as @s[distance=0.001..,tag=!invInspectItem] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectLeft] run playsound minecraft:ui.button.click master @p ~ ~ ~ 0.5 1 0.5
...
execute at 0-0-13-0-2 as @s[distance=0.001..] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectDown] as @p run playsound minecraft:ui.button.click master @s[tag=invInspectItem,scores={selectSecondary=1}] ~ ~ ~ 0.5 1 0.5
execute at 0-0-13-0-2 as @s[distance=0.001..] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectDown] as @p run scoreboard players add @s[tag=invInspectItem,scores={selectSecondary=1}] selectSecondary 1
...
execute as @s[tag=hasChangedSlotUp,tag=invInspectItem,scores={selectSecondary=2}] run scoreboard players remove @s selectSecondary 1
execute at 0-0-13-0-2 as @s[distance=0.001..] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectUp] as @p run playsound minecraft:ui.button.click master @s[tag=invInspectItem,scores={selectSecondary=2}] ~ ~ ~ 0.5 1 0.5
execute at 0-0-13-0-2 as @s[distance=0.001..] at @s as @e[tag=brewerSelect,limit=1,sort=nearest] run execute if entity @s[tag=selectUp] as @p run scoreboard players remove @s[tag=invInspectItem,scores={selectSecondary=2}] selectSecondary 1
...
execute at 0-0-13-0-2 as @s[distance=0.001..] run tag @s add lookTP
execute as @s[tag=lookTP] run tp @s 0-0-13-0-2
