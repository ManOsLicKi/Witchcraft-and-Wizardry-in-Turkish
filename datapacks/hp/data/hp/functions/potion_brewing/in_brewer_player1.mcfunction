...
# Scroll testers
execute as 0-0-13-0-1 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectUp],UUID:[I;0,20,0,1]}
execute as 0-0-13-0-1 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectDown],UUID:[I;0,20,0,2]}
execute as 0-0-13-0-1 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectLeft],UUID:[I;0,20,0,3]}
execute as 0-0-13-0-1 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectRight],UUID:[I;0,20,0,4]}
