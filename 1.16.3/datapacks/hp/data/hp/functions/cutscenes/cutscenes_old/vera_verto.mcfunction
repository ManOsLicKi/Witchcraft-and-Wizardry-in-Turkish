...
# Hack fix to prevent an issue where some players experience that the quest doens't update properly. My only explanation at this point is that writing to NBT is not 100 % reliable.
execute as @s[scores={playerID=1,trackedQuestID=20,trackedQuestState=..2}] store result entity 0-0-5-0-1 ArmorItems[3].tag."quests.veraVerto" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=2,trackedQuestID=20,trackedQuestState=..2}] store result entity 0-0-5-0-2 ArmorItems[3].tag."quests.veraVerto" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=3,trackedQuestID=20,trackedQuestState=..2}] store result entity 0-0-5-0-3 ArmorItems[3].tag."quests.veraVerto" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=4,trackedQuestID=20,trackedQuestState=..2}] store result entity 0-0-5-0-4 ArmorItems[3].tag."quests.veraVerto" int 1 run scoreboard players set @s tmp 3
