...
execute as @s[scores={cutSceneTimer=200}] run title @s subtitle ["",{"text":"The Ministry of Magic","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=200}] run title @s title {"text":"Traveling to","color":"gray"}
