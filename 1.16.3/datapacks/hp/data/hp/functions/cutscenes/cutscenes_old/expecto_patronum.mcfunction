...
execute as @s[scores={playerID=1,trackedQuestID=21,trackedQuestState=..2}] store result entity 0-0-5-0-1 ArmorItems[3].tag."quests.expectoPatronum" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=2,trackedQuestID=21,trackedQuestState=..2}] store result entity 0-0-5-0-2 ArmorItems[3].tag."quests.expectoPatronum" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=3,trackedQuestID=21,trackedQuestState=..2}] store result entity 0-0-5-0-3 ArmorItems[3].tag."quests.expectoPatronum" int 1 run scoreboard players set @s tmp 3
execute as @s[scores={playerID=4,trackedQuestID=21,trackedQuestState=..2}] store result entity 0-0-5-0-4 ArmorItems[3].tag."quests.expectoPatronum" int 1 run scoreboard players set @s tmp 3
