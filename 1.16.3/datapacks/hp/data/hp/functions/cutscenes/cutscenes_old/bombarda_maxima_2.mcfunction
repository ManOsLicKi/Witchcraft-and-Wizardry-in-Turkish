...
execute as @s[scores={cutSceneTimer=20},tag=cutsceneLeader] run setblock 7493 84 410 air
execute as @s[scores={cutSceneTimer=20},tag=cutsceneLeader] run setblock 7493 85 410 air
