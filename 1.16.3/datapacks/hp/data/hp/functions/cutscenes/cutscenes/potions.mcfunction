...
execute as @s[scores={cutSceneTimer=20..140}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Bu derste aptalca sihirli değnek sallama veya aptalca büyüler olmayacak."}]
...
execute as @s[scores={cutSceneTimer=140..320}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"İksir hazırlamak kadar incelikli bir bilimi, bu kadar hassas bir sanatı takdir edeceğinizi sanmıyorum."}]
...
execute as @s[scores={cutSceneTimer=320..420}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Ancak, yatkınlığı olan az sayıda seçilmiş kişi,"}]
...
execute as @s[scores={cutSceneTimer=420..600}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Sana zihni nasıl büyüleyeceğini ve duyuları nasıl aldatacağını öğreteceğim. sana nasıl olduğunu anlatacağım"}]
...
execute as @s[scores={cutSceneTimer=510..600}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"şöhretin şişelenmesi, şöhretin nasıl demleneceği ve hatta ölümün nasıl şişeleneceği..."}]
...
execute as @s[scores={cutSceneTimer=600..800}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Bu derste 'Gül Otu Tentürü' iksirini nasıl hazırlayacağınızı öğreneceksiniz."}]
...
execute as @s[scores={cutSceneTimer=700..800}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"tüketildiğinde sağlığınızın bir kısmını geri kazanacaktır."}]
...
execute as @s[scores={cutSceneTimer=800..970}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Bunu yapmak için bu odada ortaya konan çeşitli iksir malzemelerini toplamanız gerekir."}]
...
execute as @s[scores={cutSceneTimer=970..1170}] run title @s actionbar ["",{"text":""},{"text":"Snape;","color":"dark_gray"},{"text":"Başlayabilirsiniz."}]
