...
execute as @s[scores={cutSceneTimer=-130}] run title @s title {"text":"Seyahat etmek","color":"gray"}
...
execute as @s[scores={cutSceneTimer=800..940}] run title @s actionbar ["",{"text":""},{"text":"Alastor Moody:","color":"dark_gray"},{"text":"Bu hainler her yerde! Onları yok edin! Onlarla savaşın! Kaçmamalılar!"}]
