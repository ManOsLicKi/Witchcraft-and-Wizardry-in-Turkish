...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Harika iş!"}]
...
execute as @s[scores={cutSceneTimer=161..311}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Büyü kullanmayı öğrendiniz. Şimdi bir sonraki göreve geçelim."}]
...
execute as @s[scores={cutSceneTimer=311..400}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Merak etme."}]
...
execute as @s[scores={cutSceneTimer=400..480}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Burada böcürtler var."}]
...
execute as @s[scores={cutSceneTimer=480..650}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Karanlık yerlerde yaşıyorlar ve sizi gerçekten korkutan şeylerin şeklini alıyorlar."}]
...
execute as @s[scores={cutSceneTimer=650..800}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Antrenman için 'Sersemletme' büyüsüyle onlarla savaşmanı istiyorum."}]
...
execute as @s[scores={cutSceneTimer=800..950}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"İyi şanlar!"}]
