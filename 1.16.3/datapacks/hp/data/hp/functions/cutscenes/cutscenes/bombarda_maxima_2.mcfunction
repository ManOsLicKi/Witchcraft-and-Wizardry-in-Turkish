...
execute as @s[scores={cutSceneTimer=20..100}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Hazır!"}]
...
execute as @s[scores={cutSceneTimer=100..240}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Ama henüz işin bitmedi. Yukarı doğru ilerlemeye devam et, seninle orada buluşuruz."}]
