...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Seni tekrar gördüğüme sevindim!"}]
...
execute as @s[scores={cutSceneTimer=161..350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Sihirbazın temel becerilerinden biri havaya yükselmedir: nesneleri uçurma yeteneği."}]
...
execute as @s[scores={cutSceneTimer=351..500}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"'Wingardium Leviosa' büyüsü belirli nesneleri hareket ettirmenize izin verecektir."}]
...
execute as @s[scores={cutSceneTimer=500..600}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bir nesneye odaklanmak için £ tuşuna iki kez basın."}]
...
execute as @s[scores={cutSceneTimer=601..690}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bundan sonra baktığınız nesneyi almak için € tuşuna bir kez basın,"}]
...
execute as @s[scores={cutSceneTimer=691..760}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"ve düşürmek için tekrar € tuşuna basın."}]
...
execute as @s[scores={cutSceneTimer=761..850}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bir nesneyi havaya kaldırırken nereye gitmesi gerektiğine dikkat edin."}]
...
execute as @s[scores={cutSceneTimer=861..950}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Size olan mesafeyi değiştirmek için fare tekerleğini kullanın."}]
...
execute as @s[scores={cutSceneTimer=951..1050}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"İşiniz bittiğinde £ öğesine çift tıklayın."}]
...
execute as @s[scores={cutSceneTimer=1051..1200}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bu büyü özellikle ağır blokları hareket ettirerek mekanizmaları harekete geçirmek için kullanışlıdır."}]
...
execute as @s[scores={cutSceneTimer=1201..1350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Size bu büyüyü nasıl kullanacağınızı öğretecek engelli bir parkur hazırladım."}]
...
execute as @s[scores={cutSceneTimer=1351..1420}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Size iyi şanslar diliyorum!"}]
