...
execute as @s[scores={cutSceneTimer=20..120}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Merhaba Öğrenciler!"}]
...
execute as @s[scores={cutSceneTimer=121..210}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Bugün 'Maxim Bombard'ı kullanmayı öğreneceğiz;"}]
...
execute as @s[scores={cutSceneTimer=211..300}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"- güçlü bir patlayıcı büyü."}]
...
execute as @s[scores={cutSceneTimer=300..400}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Güçlü patlamalara neden olmanızı sağlayacak,"}]
...
execute as @s[scores={cutSceneTimer=400..550}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"birden fazla düşmana büyük hasar vermenin yanı sıra belirli duvarları ve nesneleri havaya uçurma yeteneğine sahiptir."}]
...
execute as @s[scores={cutSceneTimer=550..700}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Kalenin altında büyünün uygulanabileceği bir alan yarattım."}]
...
execute as @s[scores={cutSceneTimer=700..900}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Çıkış en üstte. Bakalım ulaşabilecek misin?"}]
...
execute as @s[scores={cutSceneTimer=900..1050}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Ah evet, senin yerinde olsaydım acele ederdim. Buradaki en hoş koku değil."}]
