...
execute as @s[scores={cutSceneTimer=20..190}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Başlamadan önce şunu söylemeliyim ki bu çok gelişmiş bir sihirdir, sıradan sihirden çok daha karmaşıktır."}]
...
execute as @s[scores={cutSceneTimer=190..290}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Sana öğreteceğim büyü Patronus Büyüsü."}]
...
execute as @s[scores={cutSceneTimer=290..410}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Patronus, sizi Ruh Emicilerden koruyabilecek bir tür pozitif güçtür."}]
...
execute as @s[scores={cutSceneTimer=410..490}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Ruh Emiciler öldürülemez."}]
...
execute as @s[scores={cutSceneTimer=490..610}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Ancak Patronus Büyüsü ile onları en azından bir süreliğine uzak tutabilirsiniz."}]
...
execute as @s[scores={cutSceneTimer=610..710}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Amaç gümüş-beyaz bir koruyucu veya koruyucu yaratmaktır."}]
...
execute as @s[scores={cutSceneTimer=710..820}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"bir hayvan şeklini alan ve Ruh Emicileri geri çekilmeye zorlayacak."}]
...
execute as @s[scores={cutSceneTimer=820..900}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Sana göstereyim"}]
...
execute as @s[scores={cutSceneTimer=960..1020}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Especto Patronum!"}]
