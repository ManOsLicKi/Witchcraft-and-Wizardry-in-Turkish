...
execute as @s[scores={cutSceneTimer=20..80}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Karanlık Sanatlara Karşı Savunma'ya hoş geldiniz!"}]
...
execute as @s[scores={cutSceneTimer=80..160}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Ben Profesör Lupin, Karanlık Sanatlara Karşı Savunma öğretmeniniz."}]
...
execute as @s[scores={cutSceneTimer=161..320}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Lütfen kitapları kaldırın, bu pratik bir ders olacak. Tek ihtiyacınız olan bir sopa."}]
...
execute as @s[scores={cutSceneTimer=320..490}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Bugün rakiplerinizi sersemletmenizi ve onlara saldırmanızı sağlayacak 'Dazed' büyüsünü öğreneceksiniz."}]
...
execute as @s[scores={cutSceneTimer=490..980}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Büyüyü çalışabilmen için hedeflerin olduğu engelli bir parkur hazırladım."}]
...
execute as @s[scores={cutSceneTimer=980..1110}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Daze büyüsü 'Q' tuşuna basılarak seçilebilir ve kullanmak için £ tuşuna iki kez basılabilir."}]
...
execute as @s[scores={cutSceneTimer=1110..1200}] run title @s actionbar ["",{"text":""},{"text":"Acı bakla;","color":"dark_gray"},{"text":"Size iyi şanslar diliyorum!"}]
