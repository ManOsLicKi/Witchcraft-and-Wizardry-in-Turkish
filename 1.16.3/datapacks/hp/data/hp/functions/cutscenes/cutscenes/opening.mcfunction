...
execute as @s[scores={cutSceneTimer=30}] run title @a[tag=cutsceneSlave] subtitle {"text":"ManOs Tarafından Çevirilmiştir","color":"gold"}
execute as @s[scores={cutSceneTimer=30}] run title @a[tag=cutsceneSlave] title {"text":"FlooNetwork tarafından"}
