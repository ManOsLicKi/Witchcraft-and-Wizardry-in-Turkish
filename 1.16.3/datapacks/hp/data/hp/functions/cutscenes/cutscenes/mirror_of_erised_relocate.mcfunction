...
execute as @s[scores={cutSceneTimer=21},tag=gameLeader] run setblock 665 85 241 minecraft:crimson_pressure_plate[powered=true]
execute as @s[scores={cutSceneTimer=21},tag=gameLeader] run setblock 665 88 241 minecraft:warped_pressure_plate[powered=true]
