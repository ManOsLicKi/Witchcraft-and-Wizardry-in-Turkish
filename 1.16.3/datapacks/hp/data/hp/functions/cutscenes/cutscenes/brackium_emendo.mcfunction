...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Seni tekrar sınıfta gördüğüme sevindim!"}]
...
execute as @s[scores={cutSceneTimer=161..300}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"İksirlerle kendinizi nasıl iyileştireceğinizi zaten öğrendiniz."}]
...
execute as @s[scores={cutSceneTimer=301..450}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Bu derste sağlığı iyileştirmenin başka bir yolu olan 'Brachiam Emendo' büyüsünü öğreneceksiniz."}]
...
execute as @s[scores={cutSceneTimer=220},tag=cutsceneLeader] positioned 5991.22 83.00 5.75 run summon armor_stand ~ ~ ~ {Small:1b,Invisible:1b,Tags:["spellEntity","BrackiumArea","BrackiumInit"],CustomName:"{\"text\":\"BrackiumArea\"}"}
...
execute as @s[scores={cutSceneTimer=450..520}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Pratik yapabileceğiniz bir alan yarattım!"}]
...
execute as @s[scores={cutSceneTimer=521..630}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Düşmanlarınızla savaşın ve büyüyü kendinizi iyileştirmek için kullanın."}]
...
execute as @s[scores={cutSceneTimer=630..740}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Shift tuşunu basılı tutarak 'Q' tuşuna basarak en önemli büyüler arasında hızlı bir şekilde geçiş yapabilirsiniz."}]
...
execute as @s[scores={cutSceneTimer=741..862}] run title @s actionbar ["",{"text":""},{"text":"Flitwick;","color":"dark_gray"},{"text":"Size iyi şanslar diliyorum!"}]
