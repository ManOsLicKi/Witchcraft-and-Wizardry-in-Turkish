...
execute store result score @s falling run data get entity 0-0-c-0-2 FallDistance 10
...
# Scroll testers
execute at 0-0-c-0-2 positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectUp],UUID:[I;0,11,0,5]}
execute at 0-0-c-0-2 positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectDown],UUID:[I;0,11,0,6]}
execute at 0-0-c-0-2 positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectLeft],UUID:[I;0,11,0,7]}
execute at 0-0-c-0-2 positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectRight],UUID:[I;0,11,0,8]}
...
# Sideways Scroll
execute as @s[tag=dropItem,tag=!hasScrolled] at 0-0-c-0-2 run function hp:inventory/side_scroll
execute as @s[tag=moveToQuickSlot,tag=!hasScrolled] at 0-0-c-0-2 run function hp:inventory/side_scroll
...
execute at 0-0-c-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!dropItem,tag=!moveToQuickSlot,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=invSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:inventory/inventory_scroll_down
...
execute at 0-0-c-0-2 unless block ~ ~ ~ water as @s[distance=0.001..,tag=!dropItem,tag=!moveToQuickSlot,tag=!hasScrolled,scores={falling=0}] at @s as @e[type=area_effect_cloud,tag=invSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:inventory/inventory_scroll_up
...
execute store result score @s tmp run data get entity 0-0-c-0-2 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-c-0-2 Rotation[1] 1000
...
execute at 0-0-c-0-2 as @s[distance=0.001..] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!delayInventoryOneTick] run tp @s 0-0-c-0-2
