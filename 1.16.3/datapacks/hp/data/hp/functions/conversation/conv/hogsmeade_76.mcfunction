...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Herhangi bir konuda yardıma mı ihtiyacınız var? \\n\\n\\n\\n\"}"}	
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bütün gün yukarıdan gelen vraklama sesleri duydum. Konsantre olmayı çok zorlaştırıyor. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
