...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Belirli bir işimiz yoksa ilgilenmiyorum. İçerideki Dervish ile konuş. Sana yardım edebilir. \\n\\n\\n\\n\"}"}
