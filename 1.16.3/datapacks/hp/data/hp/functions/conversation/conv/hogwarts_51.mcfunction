...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Biliyor musun, bu portrelerden biriyle bir sohbet başlatmaya çalışıyorum ama hepsi biraz sağır görünüyor. \\n\\n\\n\\n\"}"}
