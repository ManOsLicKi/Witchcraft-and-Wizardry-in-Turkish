...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Ben yarı yarıyayım. Babam bir Muggle; annem bir cadı. Bunu öğrendiğinde onun için biraz kötü bir şok oldu.\\n\\n\\n\\n\"}"}
