...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Durun bakalım, bu ne? Gryffindor'un pratik yapması için Quidditch sahasını rezerve ettirmiştim. \\n\\n\\n\\n\"}"}
