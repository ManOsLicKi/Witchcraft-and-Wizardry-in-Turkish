...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Sana bir bilmecem var. Potter bir kazanı nasıl karıştırıyor? Asasını tutuyor ve dünya onun etrafında dönüyor. Ha! \\n\\n\\n\\n\"}"}
