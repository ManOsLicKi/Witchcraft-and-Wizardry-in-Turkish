...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Yani bu şatodaki salonları kim tasarladı? Hiçbir sistem yok! Sadece ilerledikçe mi uyduruyorlardı?! \\n\\n\\n\"}"}
