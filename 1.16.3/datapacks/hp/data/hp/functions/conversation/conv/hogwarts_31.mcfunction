...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Başkanlar genellikle arkamdaki çalışma salonunda takılırlar, böylece onlara herhangi bir soru sormanız gerekebilir. \\n\\n\\n\\n\"}"}
