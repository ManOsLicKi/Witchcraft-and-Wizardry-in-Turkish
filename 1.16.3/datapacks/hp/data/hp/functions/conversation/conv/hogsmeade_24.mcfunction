...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Nimbus 2001'imi beğendin mi? Bu konuda senden daha hızlı koşabileceğime bahse girerim. \\n\\n\\n\\n\"}"}
