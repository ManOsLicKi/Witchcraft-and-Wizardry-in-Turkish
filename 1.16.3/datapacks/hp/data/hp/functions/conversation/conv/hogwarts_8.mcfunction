...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"O güvercin günlerdir yerinden ayrılmıyor. Acaba o kırık çeşmede neyi bu kadar seviyor? \\n\\n\\n\\n\"}"}
