...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bu gibi küçük taşınabilir bir valiziniz varsa, kimin bir bagaja ihtiyacı var? İçerisi daha büyük! \\n\\n\\n\\n\"}"}
