...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Güzel bir kıyafeti gerçekten neyin tamamladığını biliyor musun? Güzel bir şapka. \\n\\n\\n\\n\\n\"}"}
