...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\"Merhaba! Ben\"},{\"text\":\"Barliman Butterbur\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\", the owner and proprietor of The Wine Barrel Inn. How can I help you?\",\"color\":\"white\",\"bold\":\"false\"}]"}
