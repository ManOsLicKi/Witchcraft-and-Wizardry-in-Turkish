...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Sihir harika ve her şey, ama bazen lanet bir baykuş yerine bir telefon kullanabilmeyi diliyorum! \\n\\n\\n\\n\"}"}
