...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Artık mekanik Altın Snitches kullandıklarına sevindim. Eskiden snidgets kullanıyorlardı, kuş. Çok zalimce. \\n\\n\\n\\n\"}"}
