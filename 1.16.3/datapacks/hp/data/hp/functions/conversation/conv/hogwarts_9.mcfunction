...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Avluda Yılan Çukuru oynamayı dört gözle bekliyordum ama sanırım biri gobstone'larımı çaldı... \\n\\n\\n\\n\"}"}
