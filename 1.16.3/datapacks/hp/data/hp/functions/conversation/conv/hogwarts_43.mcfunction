...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Babam mezun olduktan sonra Bakanlık için çalışmam konusunda kararlı. Ben bundan pek emin değilim. \\n\\n\\n\\n\"}"}
