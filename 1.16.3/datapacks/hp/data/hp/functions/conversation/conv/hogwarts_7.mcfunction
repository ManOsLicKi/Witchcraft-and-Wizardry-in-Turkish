...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bu yön işaretleri çok büyük bir yardım. Onlar olmadan ortak odaya geri dönmenin yolunu asla bulamazdım.\\n\\n\\n\\n\"}"}
