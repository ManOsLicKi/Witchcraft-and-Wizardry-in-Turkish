...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Bunu hayatım boyunca çözemem! Teoriyi bir düzine kez çalıştım ama hala bir kibrit çöpünü iğneye dönüştüremiyorum. \\n\\n\\n\"}"}
