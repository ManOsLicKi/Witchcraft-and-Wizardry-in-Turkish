...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\"Dün gece Ravenclaw ortak salonuna giremedim. Kapı bana cevabını bulamadığım bir bilmece sordu. \\n\\n\\n\\n\"}"}
