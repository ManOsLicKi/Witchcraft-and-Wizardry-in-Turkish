...
# In Conversation
execute as 0-0-e-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectUp],UUID:[I;0,15,0,9]}
execute as 0-0-e-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectDown],UUID:[I;0,15,0,10]}
execute as 0-0-e-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectLeft],UUID:[I;0,15,0,11]}
execute as 0-0-e-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectRight],UUID:[I;0,15,0,12]}
...
execute at 0-0-e-0-3 as @s[distance=0.001..,tag=!softExitConv,tag=!inInventory,tag=!hasScrolled] at @s as @e[type=area_effect_cloud,tag=convSelect,limit=1,sort=nearest] if entity @s[tag=selectDown] as @p[tag=activePlayer] run function hp:conversation/conversation_scroll_down
...
execute at 0-0-e-0-3 as @s[distance=0.001..,tag=!softExitConv,tag=!inInventory,tag=!hasScrolled] at @s as @e[type=area_effect_cloud,tag=convSelect,limit=1,sort=nearest] if entity @s[tag=selectUp] as @p[tag=activePlayer] run function hp:conversation/conversation_scroll_up
...
# Lock player look
execute store result score @s tmp run data get entity 0-0-e-0-3 Rotation[0] 1000
...
execute store result score @s tmp run data get entity 0-0-e-0-3 Rotation[1] 1000
...
execute at 0-0-e-0-3 as @s[distance=0.001..] run tag @s add lookTP
execute as @s[tag=lookTP,tag=!inInventory] run tp @s 0-0-e-0-3
