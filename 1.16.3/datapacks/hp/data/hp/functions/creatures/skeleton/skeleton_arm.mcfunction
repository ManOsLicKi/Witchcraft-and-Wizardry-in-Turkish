...
execute as @s[tag=!attack,scores={animTest=57}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.125}]}
execute as @s[tag=!attack,scores={animTest=50}] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0}]}
execute as @s[tag=attack] run data merge entity @s {Attributes:[{Name:generic.movement_speed,Base:0.1}]}
