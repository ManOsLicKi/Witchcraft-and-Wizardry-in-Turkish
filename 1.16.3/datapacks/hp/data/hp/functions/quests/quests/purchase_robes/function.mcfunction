...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1502,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2..5},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1501,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=1,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Purchase 'House Robe'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=1,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Purchase some headwear","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=1,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Purchase a set of trousers","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=2,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Purchase 'House Robe'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=2,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Purchase some headwear","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=2,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Purchase a set of trousers","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=3,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Purchase 'House Robe'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=3,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Purchase some headwear","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=3,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Purchase a set of trousers","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=4,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Purchase 'House Robe'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=4,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Purchase some headwear","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=4,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Purchase a set of trousers","color":"gold"}]
...
execute as @s[scores={questState=6},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1500,Unbreakable:1b,qDetect:1b}
