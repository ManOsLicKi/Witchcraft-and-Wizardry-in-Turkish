...
setblock 2004 12 799 minecraft:lantern[hanging=true,waterlogged=false]
...
setblock 2004 11 799 minecraft:crimson_pressure_plate[powered=true]
setblock 2004 14 799 minecraft:warped_pressure_plate[powered=true]
