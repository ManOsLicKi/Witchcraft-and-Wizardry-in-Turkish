...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1405,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1404,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Defeat 10 Poltergeists (","color":"gold"},{"score":{"name":"shriekingShackPoltergeistKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=2,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Defeat 10 Poltergeists (","color":"gold"},{"score":{"name":"shriekingShackPoltergeistKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=2,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Defeat 10 Poltergeists (","color":"gold"},{"score":{"name":"shriekingShackPoltergeistKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 10)","color":"gold"}]
execute as @s[scores={questState=2,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Defeat 10 Poltergeists (","color":"gold"},{"score":{"name":"shriekingShackPoltergeistKills","objective":"sharedQuests"},"color":"gold"},{"text":" of 10)","color":"gold"}]
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Marauders Map\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1403,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ I've taken care of the noise\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
