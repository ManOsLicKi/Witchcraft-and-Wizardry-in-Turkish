...
execute as @s[scores={menuPlayerID=2..,mainMenuState=1}] unless entity @p[scores={menuPlayerID=1,mainMenuState=2..}] run title @s actionbar ["",{"text":"Oyunun başlaması için"},{"selector":"@p[scores={menuPlayerID=1}]"},{"text":" bekle"}]
