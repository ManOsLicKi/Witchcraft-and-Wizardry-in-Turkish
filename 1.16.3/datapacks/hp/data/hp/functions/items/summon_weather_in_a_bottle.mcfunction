summon wither_skeleton ~ ~2 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,Marker:1b,Tags:["spellEntity","weatherInABottle","weatherInABottleBeingSummoned"],Motion:[0.0d,0.075d,0.0d],ArmorItems:[{},{},{},{id:"minecraft:golden_hoe",Count:1b,tag:{Unbreakable:1b,Damage:32}}],Attributes:[{Name:generic.max_health,Base:1000},{Name:generic.follow_range,Base:0},{Name:generic.knockback_resistance,Base:1000},{Name:generic.movement_speed,Base:0},{Name:generic.attack_damage,Base:0},{Name:generic.armor,Base:1000},{Name:generic.armor_toughness,Base:1000}]}
